...
class AppPostType
{
	...
	public static $_PostTypeName = "app";
	public static $_PostTypeName_Shift = "App";
...
class AppDetailMetabox extends scbPostMetabox
{
	private $formFields;
	...
	{
		$field['name'] = $this->_PostTypeName ."_detail_". $field['name'];
