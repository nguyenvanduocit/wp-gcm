...
class DevicePostType
{
	...
	public static $_PostTypeName = "device";
	public static $_PostTypeName_Shift = "Device";
	...
	function register()
	{
        ...
        //add_action('publish_'.self::$_PostTypeName, array( __CLASS__, 'wpSub_on_publish_post'));
...
class DeviceDetailMetabox extends scbPostMetabox
{
	private $formFields;
